...
export default function DemoDebatePage({
  params,
}: {
  ...
  return (
    <PageShell
      ...
      subtitle={`Simulación determinista de ${sim.rounds.length} rondas de negociación entre los ${stakeholders.length} decisores`}
      currentStep={3}
