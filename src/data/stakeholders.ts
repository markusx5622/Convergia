...
export const stakeholders: Stakeholder[] = [
  {
    ...
    style: {
      argumentative: 'Directo, pragmático, basado en datos operativos.',
      concession: 'Acepta concesiones si se garantiza mínimo impacto en disponibilidad.',
    },
  },
  {
    id: 'quality',
    ...
    style: {
      argumentative: 'Metódico, basado en estándares y normativa.',
      concession: 'Acepta concesiones en velocidad si se mantiene calidad.',
    },
  },
  {
    id: 'finance',
    ...
    acceptabilityThreshold: 0.35,
    style: {
      argumentative: 'Analítico, escéptico, basado en números.',
      concession: 'Acepta mayor inversión si el ROI se demuestra con datos.',
    },
  },
  {
    id: 'sustainability',
    ...
    acceptabilityThreshold: 0.30,
    style: {
      argumentative: 'Visionario pero con datos regulatorios.',
      concession: 'Acepta impacto ambiental menor si se compensa con plan a medio plazo.',
    },
  },
];
